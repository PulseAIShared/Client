    ...
    <LandingLayout>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-blue-500/10 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-400/20 mb-6">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-sm font-medium text-blue-600 dark:text-blue-400">Book Your Personal Demo</span>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-surface-primary rounded-xl p-6 border border-border-primary">
                ...
                <h3 className="text-lg font-semibold text-text-primary mb-2">See Real Results</h3>
              ...
              <div className="bg-surface-primary rounded-xl p-6 border border-border-primary">
                ...
                <h3 className="text-lg font-semibold text-text-primary mb-2">Custom Strategy</h3>
                <p className="text-text-secondary text-sm">
              ...
              <div className="bg-surface-primary rounded-xl p-6 border border-border-primary">
                ...
                <h3 className="text-lg font-semibold text-text-primary mb-2">ROI Calculator</h3>
                <p className="text-text-secondary text-sm">
