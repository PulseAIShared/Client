            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
                <div className="bg-surface-secondary/50 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-border-primary/50">
                  ...
                  <CompanyAuthorization
                    ...
                    forbiddenFallback={
                      <div className="px-3 sm:px-4 py-1.5 sm:py-2 bg-surface-secondary/50 text-text-muted rounded-lg text-xs sm:text-sm border border-border-primary/50 w-full cursor-not-allowed">
                        View Only Access
                      </div>
                    }
                  >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <CompanyAuthorization
                  policyCheck={canManageRecoveryFlows}
                  forbiddenFallback={
                    <div className="px-6 py-3 bg-surface-secondary/50 text-text-muted rounded-lg font-medium border border-border-primary/50 cursor-not-allowed">
