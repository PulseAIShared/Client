  ...
  return (
    <ContentLayout>
      <div className="space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full px-3 py-2 bg-surface-secondary/50 hover:bg-surface-secondary/60 hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200 text-text-primary border border-border-primary/50 rounded-lg"
              >
                Clear Filters
              </button>
            </div>
        ...
        {/* Campaigns List */}
        {campaigns.length === 0 ? (
          <div className="bg-surface-secondary/50 backdrop-blur-lg rounded-2xl p-12 border border-border-primary/50 shadow-xl text-center">
            ...
            <Link 
              ...
              className="inline-block px-6 py-2 bg-accent-primary hover:bg-accent-primary/80 hover:shadow-lg hover:shadow-accent-primary/25 transform hover:-translate-y-0.5 transition-all duration-200 text-text-primary rounded-lg"
            >
          ...
          <div className="grid grid-cols-1 gap-6">
            {campaigns.map((campaign) => (
              <div
                key={campaign.id}
                className="bg-surface-secondary/50 backdrop-blur-lg rounded-2xl p-6 border border-border-primary/50 shadow-xl hover:border-border-primary/60 hover:shadow-2xl transition-all duration-200"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button className="px-3 py-1 text-sm bg-surface-secondary/50 hover:bg-surface-secondary/60 hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200 text-text-primary border border-border-primary/50 rounded">
                      View Details
                    </button>
                  </div>
                </div>
