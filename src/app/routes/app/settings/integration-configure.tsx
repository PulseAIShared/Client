  ...
  return (
    <div className="space-y-6">
      <div className="bg-surface-secondary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-lg">
        <h2 className="text-xl font-semibold mb-2">Configure {integration.name}</h2>
        <p className="text-text-secondary">Choose what to sync and how often. You’ll be able to start the first sync once this is saved.</p>
      </div>
