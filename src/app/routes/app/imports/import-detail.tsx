      ...
      <ContentLayout>
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-error/10 to-warning/10 rounded-2xl blur-3xl"></div>
            ...
            <div className="relative bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-error-muted">Import Job Not Found</h1>
      ...
      <div className="space-y-8">
          ...
          <div className="relative bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-xl">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="inline-flex items-center gap-2 bg-accent-secondary/20 backdrop-blur-sm px-4 py-2 rounded-full border border-accent-secondary/30">
                        <div className="w-2 h-2 bg-success-muted rounded-full animate-pulse"></div>
                        <span className="text-sm font-medium text-accent-secondary">Import Job Details</span>
                      </div>
                    ...
                    <p className="text-text-secondary">Import ID: {importJob.id}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <Link 
                  to="/app/customers"
                  className="px-4 py-2 bg-surface-secondary/50 text-text-primary rounded-lg hover:bg-surface-secondary/70 transition-colors font-medium text-sm border border-border-primary/50"
                >
                  View Customers
                </Link>
                <Button 
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="bg-surface-primary/50 backdrop-blur-lg p-4 rounded-2xl border border-border-primary/50 shadow-lg">
            ...
            <div className="text-2xl font-bold text-text-primary">{importJob.totalRecords.toLocaleString()}</div>
          </div>
          ...
          <div className="bg-surface-primary/50 backdrop-blur-lg p-4 rounded-2xl border border-border-primary/50 shadow-lg">
            ...
            <div className="text-2xl font-bold text-success-muted">{importJob.successfulRecords.toLocaleString()}</div>
          </div>
          ...
          <div className="bg-surface-primary/50 backdrop-blur-lg p-4 rounded-2xl border border-border-primary/50 shadow-lg">
            ...
            <div className="text-2xl font-bold text-accent-secondary">{importJob.newRecords.toLocaleString()}</div>
          </div>
          ...
          <div className="bg-surface-primary/50 backdrop-blur-lg p-4 rounded-2xl border border-border-primary/50 shadow-lg">
            ...
            <div className="text-2xl font-bold text-warning-muted">{importJob.updatedRecords.toLocaleString()}</div>
          </div>
          ...
          <div className="bg-surface-primary/50 backdrop-blur-lg p-4 rounded-2xl border border-border-primary/50 shadow-lg">
            ...
            <div className="text-2xl font-bold text-error-muted">{importJob.failedRecords.toLocaleString()}</div>
          </div>
          ...
          <div className="bg-surface-primary/50 backdrop-blur-lg p-4 rounded-2xl border border-border-primary/50 shadow-lg">
            ...
            <div className="text-2xl font-bold text-warning-muted">{importJob.skippedRecords.toLocaleString()}</div>
          </div>
        </div>
        ...
        <div className="bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-text-primary">Progress</h3>
            <span className="text-2xl font-bold text-accent-primary">{Math.round(importJob.progressPercentage)}%</span>
          </div>
          <div className="w-full bg-surface-secondary/50 rounded-full h-4 overflow-hidden">
            <div 
              className="bg-gradient-to-r from-accent-primary to-accent-secondary h-4 rounded-full transition-all duration-1000 ease-out"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Import Details */}
          <div className="bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-lg">
            <h3 className="text-xl font-semibold text-text-primary mb-6">Import Details</h3>
          ...
          <div className="bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-lg">
            {importJob.summary ? (
              <>
                <h3 className="text-xl font-semibold text-success-muted mb-6">Import Summary</h3>
                <div className="space-y-4">
              ...
              <>
                <h3 className="text-xl font-semibold text-text-primary mb-6">Status Information</h3>
        ...
        {importJob.updates && importJob.updates.length > 0 && (
          <div className="bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-lg">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-warning-muted">Customer Updates</h3>
            ...
            <div className="space-y-4 max-h-80 overflow-y-auto">
              {importJob.updates.map((update, index) => (
                <div key={index} className="p-4 bg-warning/10 rounded-lg border border-warning/30">
        ...
        {importJob.validationErrors && importJob.validationErrors.length > 0 && (
          <div className="bg-surface-primary/50 backdrop-blur-lg p-6 rounded-2xl border border-border-primary/50 shadow-lg">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-warning-muted">
        ...
        {importJob.errorMessage && (
          <div className="bg-error/20 backdrop-blur-lg p-6 rounded-2xl border border-error/30 shadow-lg">
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-error-muted mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
              </svg>
              <div>
                <h3 className="text-error-muted font-semibold text-lg mb-2">Error Details</h3>
