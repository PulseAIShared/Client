...
export const TopNav = () => {
  ...
  const Logo = () => {
    return (
      <div className="flex items-center gap-2 group">
        ...
        <Code fw={700} className="text-xs bg-accent-secondary/20 text-accent-secondary border border-accent-secondary/30 rounded px-1.5 py-0.5">
          BETA
        </Code>
      </div>
    );
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-30 flex h-14 sm:h-16 items-center justify-between bg-surface-primary/95 backdrop-blur-xl px-4 sm:px-6 text-text-primary border-b border-border-primary/30 shadow-lg">
            ...
            <div className="absolute right-0 mt-2 w-64 bg-surface-primary/95 backdrop-blur-xl border border-border-primary/30 rounded-2xl shadow-2xl py-2 z-50 animate-in slide-in-from-top-2 duration-200">
              ...
              <div className="px-4 py-3 border-b border-border-primary/30">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-accent-primary to-accent-secondary rounded-full flex items-center justify-center text-white font-medium shadow-sm">
                    {getUserInitials()}
                  </div>
              ...
              <div className="py-2">
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-2 text-text-secondary hover:text-text-primary hover:bg-surface-secondary/50 transition-all duration-200 group"
                >
                ...
                {/* Theme Toggle - Only show on mobile */}
                {isMobile && (
                  <button
                    onClick={() => {
                      toggleTheme();
                    ...
                    className="flex items-center gap-3 px-4 py-2 text-text-secondary hover:text-text-primary hover:bg-surface-secondary/50 transition-all duration-200 w-full text-left group"
                  >
                    {theme === 'dark' ? (
                      <>
                        <svg className="w-4 h-4 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="border-t border-border-primary/30 pt-2">
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-2 text-error-muted hover:text-error hover:bg-error/10 transition-all duration-200 w-full text-left disabled:opacity-50 disabled:cursor-not-allowed group"
                >
                  {logout.isPending ? (
