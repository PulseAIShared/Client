...
import { FirstTimeEmptyState } from './first-time-empty-state';
    ...
    <div className="space-y-6">
      ...
      {filteredSegments.length === 0 ? (
        <div className="bg-surface-primary/80 backdrop-blur-lg rounded-2xl border border-border-primary/30 p-8 text-center shadow-lg">
          ...
          <h3 className="text-lg font-medium text-text-primary mb-2">No segments match your filters</h3>
          <p className="text-text-muted">Try broadening your search or selecting a different type.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
