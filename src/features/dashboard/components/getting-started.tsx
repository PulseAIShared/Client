  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-lg p-8 rounded-2xl border border-blue-500/30 shadow-xl overflow-hidden">
        ...
        <div className="relative text-center">
          <div className="inline-flex items-center gap-2 bg-blue-500/20 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-400/30 mb-6">
            ...
            <span className="text-sm font-medium text-blue-200">Welcome to PulseAI</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="bg-slate-800/50 backdrop-blur-lg p-6 rounded-2xl border border-slate-700/50 shadow-lg hover:shadow-xl hover:border-blue-500/50 transition-all duration-300 h-full">
        ...
        <Link 
          ...
          className="group block"
        >
          <div className="bg-slate-800/50 backdrop-blur-lg p-6 rounded-2xl border border-slate-700/50 shadow-lg hover:shadow-xl hover:border-green-500/50 transition-all duration-300 h-full">
            <div className="flex items-start gap-4 mb-4">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-sm mb-6">
              Once you have customer data in PulseAI, you'll unlock powerful features for retention and growth.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-600/30">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-white text-sm">Run Churn Analysis</h4>
            </div>
          ...
          <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-600/30">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-white text-sm">Create Segments</h4>
            </div>
            <p className="text-xs text-slate-400">
          ...
          <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-600/30">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-white text-sm">Launch Campaigns</h4>
            </div>
            <p className="text-xs text-slate-400">
